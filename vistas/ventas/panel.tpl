<div id="panelVenta">
	...
	<div class="box paneles" id="pnlProductos" style="display: none">
			...
			<div class="widthfull">
				<form class="form-horizontal" id="frmFiltro">
					<div class="input-group">
						...
						<input id="txtFiltro" placeholder="Producto" class="form-control">
		...
		<div class="row dvFiltro">
			<div class="widthfull">
				<button class="btn btn-danger btn-block" id="btnCancelarAddProducto">Cancelar</button>
			</div>
		</div>
		<div id="lstProductos">
	...
	<div class="box paneles" id="pnlVentaProductos"  style="display: none">
		<button class="btn btn-primary" id="btnPanelAddProducto"> + </button>
		<button class="btn btn-warning" id="btnPanelPagar"> <i class="fa fa-money" aria-hidden="true"></i></button>
		<div class="row">
			...
			<div class="col-sm-12">
				<div class="box">
					<div class="box-body">
						<div class="btn-group btn-group-justified">
							<div class="btn-group">
								<button class="btn btn-primary" id="btnGuardar">Guardar para después / apartar</button>
							</div>
						</div>
						<div class="btn-group btn-group-justified">
							<div class="btn-group">
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="row">
						<label for="txtCodigo" class="col-xs-3 text-right">Descripción</label>
						<div class="col-xs-9">
					...
					<div class="row">
						...
						<div class="col-xs-9">
							<div class="input-group">
								...
								<input class="form-control input-xs text-right" campo="precio" disabled="true" readonly="true">
							</div>
						</div>
					</div>
					<hr />
					...
					<div class="row">
						...
						<div class="col-xs-4">
							<input class="form-control input-xs" campo="existencias" disabled="true" readonly="true">
						</div>
					</div>
					<div class="row">
						<label for="txtCodigo" class="col-xs-3 text-right">Inventario actual</label>
						<div class="col-xs-4">
							<input class="form-control input-xs" campo="inventario" disabled="true" readonly="true">
						</div>
					</div>
					<div class="row">
						...
						<div class="col-xs-4">
							<div class="input-group">
								<span class="input-group-addon" id="basic-addon2"><small>%</small></span>
